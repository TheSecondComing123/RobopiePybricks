...
class Robot:
    ...
    def move_front_motor(self, rotation_deg, speed_dps=360, wait=True):
        """
        ...
        self.lift_arm_motor.run_angle(speed_dps, rotation_deg,
                                      then=Stop.HOLD, wait=wait)

    def move_back_motor(self, rotation_deg, speed_dps=360, wait=True):
        """
    ...
    def run_lift_arm(self, rotation_deg, speed_dps=1000, wait=True):
        """
